...
class ResistanceCalc(Qw.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.color_lookup = [
            b"#000000",  # Colors as specified by the IEC.
            b"#800000",
            b"#FF0000",
            b"#FF9900",
            b"#FFFF00",
    ...
    def change_band_colors_4b(self):
        idx1 = (
            self.comboBox_1d_4b.currentIndex() + 1
        )  # Black not available, skipping 0 index
        idx2 = self.comboBox_2d_4b.currentIndex()
        idm = self.comboBox_m_4b.currentIndex()
        idt = (
            self.comboBox_t_4b.currentIndex() + 1
        )  # Black not available, skipping 0 index
        ...
        # Hot patch SVG file
        current_data = (
            self.svg_data_4b.replace(b"#400001", self.color_lookup[idx1])
    ...
    def change_band_colors_5b(self):
        ...
        # Hot patch SVG file
        current_data = (
            self.svg_data_5b.replace(b"#500001", self.color_lookup[idx1])
    ...
    def change_band_colors_6b(self):
        ...
        # Hot patch SVG file
        current_data = (
            self.svg_data_6b.replace(b"#600001", self.color_lookup[idx1])
    ...
    def calculate_res_4b(self):
        ...
        value, min_value, max_value = gh.calculate_values(
            tolerance, mantissa, multiplier
        )

        r, attr = gh.edit_format_resistance(value, 3)

        self.lineEdit_resistance_4b.setText(f"{r}")
        self.label_resistance_4b.setText(f"{attr}  ±{tolerance}")
    ...
    def populate_combo_boxes(self):
        ...
        icons["black"].addFile(
            ":/colors/Color Squares/black.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        ...
        icons["brown"].addFile(
            ":/colors/Color Squares/brown.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["red"] = Qg.QIcon()
        icons["red"].addFile(
            ":/colors/Color Squares/red.png", Qc.QSize(), Qg.QIcon.Normal, Qg.QIcon.Off
        )
        icons["orange"] = Qg.QIcon()
        icons["orange"].addFile(
            ":/colors/Color Squares/orange.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["yellow"] = Qg.QIcon()
        icons["yellow"].addFile(
            ":/colors/Color Squares/yellow.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        ...
        icons["green"].addFile(
            ":/colors/Color Squares/green.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["blue"] = Qg.QIcon()
        icons["blue"].addFile(
            ":/colors/Color Squares/blue.png", Qc.QSize(), Qg.QIcon.Normal, Qg.QIcon.Off
        )
        icons["violet"] = Qg.QIcon()
        icons["violet"].addFile(
            ":/colors/Color Squares/violet.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["gray"] = Qg.QIcon()
        icons["gray"].addFile(
            ":/colors/Color Squares/gray.png", Qc.QSize(), Qg.QIcon.Normal, Qg.QIcon.Off
        )
        icons["white"] = Qg.QIcon()
        icons["white"].addFile(
            ":/colors/Color Squares/white.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["gold"] = Qg.QIcon()
        icons["gold"].addFile(
            ":/colors/Color Squares/gold.png", Qc.QSize(), Qg.QIcon.Normal, Qg.QIcon.Off
        )
        icons["silver"] = Qg.QIcon()
        icons["silver"].addFile(
            ":/colors/Color Squares/silver.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        icons["pink"] = Qg.QIcon()
        icons["pink"].addFile(
            ":/colors/Color Squares/pink.png", Qc.QSize(), Qg.QIcon.Normal, Qg.QIcon.Off
        )
        icons["blank"] = Qg.QIcon()
        icons["blank"].addFile(
            ":/colors/Color Squares/blank.png",
            Qc.QSize(),
            Qg.QIcon.Normal,
            Qg.QIcon.Off,
        )
        ...
        attach_tolerance(
            self.comboBox_t_4b, True
        )  # "True" enables the 20% tolerance band
        # Assign 5 Band
